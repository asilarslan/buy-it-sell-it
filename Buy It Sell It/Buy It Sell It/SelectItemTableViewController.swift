...
//  FinanceApp
//
//  Created by Asil Arslan on 6.11.2018.
...
class SelectItemTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "select_item", for: indexPath)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        delegate.selectedItem(index: self.index, item: items[indexPath.row])
